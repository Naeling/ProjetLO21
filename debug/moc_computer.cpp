...
QT_MOC_LITERAL(3, 23, 12) // "modifMessage"

    },
    "Pile\0modificationEtat\0\0modifMessage"
};
...
void Pile::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Pile::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Pile::modifMessage)) {
                *result = 1;
                return;
            }
        }
...
QT_MOC_LITERAL(1, 11, 12), // "modifMessage"
QT_MOC_LITERAL(2, 24, 0) // ""

    },
    "Controleur\0modifMessage\0"
};
#undef QT_MOC_LITERAL
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Controleur *_t = static_cast<Controleur *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->modifMessage(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            typedef void (Controleur::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Controleur::modifMessage)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Controleur::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Controleur.data,
      qt_meta_data_Controleur,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Controleur::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Controleur.stringdata0))
        return static_cast<void*>(const_cast< Controleur*>(this));
    return QObject::qt_metacast(_clname);
}
